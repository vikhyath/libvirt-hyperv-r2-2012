...
ACLOCAL = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run aclocal-1.11
ADDR2LINE = /usr/bin/addr2line
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run tar
...
AUTOCONF = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run automake-1.11
AVAHI_CFLAGS = 
AVAHI_LIBS = 
AWK = gawk
BHYVE = 
...
LIBVIRT_VERSION = 1.2.4
LIBVIRT_VERSION_INFO = 1002:4:1002
LIBVIRT_VERSION_NUMBER = 1002004
LIBXENSERVER_CFLAGS = 
LIBXENSERVER_LIBS = 
LIBXL_CFLAGS = 
LIBXL_LIBS = 
...
MAKEINFO = ${SHELL} /usr/local/src/libvirt/build-aux/missing --run makeinfo
MINGW_EXTRA_LDFLAGS = 
MKDIR_P = /bin/mkdir -p
MKFS = /sbin/mkfs
...
OBJDUMP = objdump
OBJEXT = o
OPENWSMAN_CFLAGS = -I/usr/include/openwsman  
OPENWSMAN_LIBS = -lwsman -lwsman_client -lwsman_curl_client_transport  
OTOOL = 
OTOOL64 = 
OVSVSCTL = ovs-vsctl
PACKAGE = libvirt
...
YAJL_CFLAGS = 
YAJL_LIBS = -lyajl
abs_aux_dir = /usr/local/src/libvirt/build-aux
abs_builddir = /usr/local/src/libvirt
abs_srcdir = /usr/local/src/libvirt
abs_top_builddir = /usr/local/src/libvirt
abs_top_srcdir = /usr/local/src/libvirt
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /usr/local/src/libvirt/build-aux/install-sh
